...
import { getListPemilihBaru, editListPemilihBaru } from "../../actions/pemilihBaruActions";

import { NavbarAdmin } from "../../componentsAdmin";

const PemilihBaruAdmin = () => {
    ...
    const handleDidaftarkan = (e, id) => {
        e.preventDefault();

        dispatch(editListPemilihBaru(id));
            ...
            <div className="mx-auto ml-32 p-24">
                <div className="overflow-x-auto">
                    ...
                    <table className="table bg-satu" encType="multipart/form-data">
                        ...
                        {getListPemilihBaruResult ? (
                            <tbody>
                                {getListPemilihBaruResult.map((surek, index) => (
                                                    ...
                                                    {surek.status === "diajukan" ? (
                                                        <>
                                                            <button
                                                                ...
                                                                onClick={(event) => handleDidaftarkan(event, surek.id)}
...
export default PemilihBaruAdmin;